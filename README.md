...
*Another change is also required to run Nuevo M&eacute;xico with PostgreSQL. Replace line 38 in application.py, line 91 in database_setup_postgres.py, and line 7 in populator.py with the following:*
